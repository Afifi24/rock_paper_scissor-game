...
const Rules = ({setIsopen,isopen}) => {
  return (
    <div className='absolute z-10  flex items-center bg-black bg-opacity-50 justify-center w-full h-full left-0 right-0 top-0  '>
        <div className='bg-white h-full w-full md:w-fit md:h-fit md:mx-4 max-w-sm flex flex-col gap-48 md:gap-6 p-10 md:rounded-lg'>
            ...
            <img onClick={()=>setIsopen(!isopen)} className='cursor-pointer absolute bottom-20 left-1/2 -translate-x-1/2 md:hidden block ' src={close} alt="" />
